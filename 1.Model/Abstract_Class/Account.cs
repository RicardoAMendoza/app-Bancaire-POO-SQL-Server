...
namespace _1.Model.Abstract_Class
{
        ...
        public abstract class Account
        {
            ...
            public Account(string vNumber, string vType, string vClientName, string vClientlastName, decimal vBalance, int vDay, int vMonth, int vYear)
            {
                Number = vNumber;
                Type = vType;
            ...
            public virtual void OpenAccount(string vNumber, string vType, string vClientName, string vClientlastName, decimal vBalance, int vDay, int vMonth, int vYear)
            {
                Number = vNumber;
                Type = vType;
                ClientName = vClientName;
