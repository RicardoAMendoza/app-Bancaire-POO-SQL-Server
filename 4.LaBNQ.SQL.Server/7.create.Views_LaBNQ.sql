...
-- Name : viewClients
-- Description:	View clients et agences FROM bdLaBanqueNationaleduQuebec
-- 1.- viewClient
-- =====================================================
...
-- Description:	View clients accounts FROM bdLaBanqueNationaleduQuebec
-- 2.- viewClientComptes
-- =====================================================
USE [bdLaBanqueNationaleduQuebec]
GO
...
-- Create date: 2025-01-26
-- Name : viewAgences
-- Description:	View agence FROM bdLaBanqueNationaleduQuebec
-- 3.- viewAgences
-- =====================================================
USE bdLaBanqueNationaleduQuebec
GO
